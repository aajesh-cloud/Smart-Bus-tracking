...
// A small helper component that lives INSIDE the map, since Leaflet's
// map instance is only accessible via useMap() from within MapContainer's children
const MapFocusController = ({ focusedBusId, liveBuses }) => {
  ...
  return null; // this component only performs an action, renders nothing visible
};
